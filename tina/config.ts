          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "text", label: "Text", ui: { component: "textarea" } },
              {
                type: "string",
                name: "modal_value",
                label: "Welches Formular vorauswählen?",
                description: "Bestimmt welche Option im Kontaktformular vorausgewählt ist wenn jemand den Button klickt.",
                options: ["einzel", "prozess", "gruppe", "b2b", "allgemein"],
              },
            ],
          },
        ],
